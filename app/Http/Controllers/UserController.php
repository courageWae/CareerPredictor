...
class UserController extends Controller
{
    ...
    {
        $step_1 = step_1::where('user_id', auth()->user()->id)->get() ;
        $step_2 = step_2::where('user_id', auth()->user()->id)->get() ;
        $step_3 = step_3::where('user_id', auth()->user()->id)->get() ;
        $step_4 = step_4::where('user_id', auth()->user()->id)->get() ;
        $step_5 = step_5::where('user_id', auth()->user()->id)->get() ;
