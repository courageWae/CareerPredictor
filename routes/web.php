...
Route::name('training.')->prefix('career_predictor')->group(function(){
	Route::get('start','TrainingController@step_1')->name('step_1');
    Route::get('step_1', 'TrainingController@step_2')->name('step_2') ;
    Route::get('step_2', 'TrainingController@step_3')->name('step_3') ;
    Route::get('step_3', 'TrainingController@step_4')->name('step_4') ;
    Route::get('step_4', 'TrainingController@step_5')->name('step_5') ;

    Route::post('step_1', 'q1Controller@storeInSession1')->name('store1');
    Route::post('step_2', 'q1Controller@storeInSession2')->name('store2');
    Route::post('step_3', 'q1Controller@storeInSession3')->name('store3');
    Route::get('predictor/step_4/{answer?}', 'q1Controller@storeInSession4')->name('store4');
    Route::get('predictor/step_5/{answer?}', 'q1Controller@storeInSession5')->name('store5');
    Route::get('register', 'q1Controller@storeInSession5')->name('register');
...
Route::group(['middleware'=>['user','auth'],'prefix'=>'user'],function(){
    Route::post('store/questions', 'q1Controller@')->name('store4');
    Route::get('predictor/results', 'CareerController@index')->name('predictor.results');
